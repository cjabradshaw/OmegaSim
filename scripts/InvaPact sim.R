...
impact.wR1 <- c(0.7,0.8,0.9,0.8,0.95) # impact probability weights
...
impact.wR2 <- c(0.7,0.8,0.9,0.9,0.95) # impact probability weights
...
impact.wR3 <- c(0.95,0.9,0.8,0.7,0.5) # impact probability weights
conf.wR3 <- c(0.6,0.9,0.4) # confidence probability weights
